...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="Client_Full_Name_registration.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Client Registration</a>
                ...
                <form action="clientinsert.php" method="POST">
                    ...
                    <div class="modal-body">
                         <div class="form-group">
                            <label>ID No<i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                        ...
                        <div class="form-group">
                            <label> Client_Full_Name </label>
                            <input type="text" name="Client_Full_Name" class="form-control" placeholder="Enter Client_Full_Name">
                        </div>
    ...
    <input type="hidden" name="update_id" id="update_id">
                     ...
                     <div class="form-group">
						...
						<div class="form-group">
                            <label> Subcity </label>
                            <input type="text" name="Woreda"  id="Woreda"   class="form-control" placeholder="Enter Woreda">
                        </div>
						<div class="form-group">
                            <label> House Number </label>
                            <input type="text" name="House"  id="House"       class="form-control" placeholder="Enter House">
                        </div>
						<div class="form-group">
                            <label> Special Name </label>
                            <input type="text" name="Special"  id="Special"     class="form-control" placeholder="Enter City">
                        </div>
...
<a href=" User_Data.php"> <button> Add User Data</button> </a>
</div>
