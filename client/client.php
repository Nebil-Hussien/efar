...
<img src="img\E-far logo.png" alt="E-Far logo" width="200" height="100"/>  </a>
 ...
 <a href="client.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Client Registration</a>
                   ...
                   <form action="client_insertion.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Client_First_Name" class="form-control" placeholder="Enter Client First Name" pattern="[A-Za-z]{1,32}" title="Please enter with prorper name format " required>
                        </div>
                      ...
                      <input type="radio" name="gender" value="female"required> Female
						...
						<br>
						  <div class="form-group">
                            ...
                            <input type="text" name="Work" class="form-control" placeholder="Enter Work Field" required>
                        </div>
						...
						<div class="form-group">
                            ...
                            <input type="text" name="House" class="form-control" placeholder="Enter House" required>
                        </div>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="https://www.elebatsolution.com/">ELEBATSOLUTION</a>, All Right Reserved. 
                        </div>
