...
<?php
  ...
  <div class="col-12 col-sm-6">
                                ...
                                <div class="form-group">
								 ...
								 <div class="form-group">
								   ...
								   <div class="col-12 col-sm-6">
                                    ...
                                    <input type="text" name="numberofFamily" id="numberofFamily" class="form-control" required>
                                </div></div>
								   <div class="col-12 col-sm-6">
								    <div class="form-group">
                                    <label> City </label>
        ...
        <a href="test1.php">  <button type="button" class="btn btn-success editbtn"> EDIT </button></a>
                                            </td>
                                            <td>
