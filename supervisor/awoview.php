                        ...
                        <form action="updateawodr.php" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sid" id="sid" class="form-control"pattern="[a-zA-Z][a-zA-Z0-9/-_\s]*" required>
                                </div>
								...
								<div class="form-group">
								 ...
								 <div class="form-group">
                                    ...
                                    <input type="text" name="familySize" id="familySize" class="form-control" required>
								 	...
								 	<div class="form-group">
                                    <label> Number of Family Subscribed </label>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="bg-light rounded h-100 p-4">
                        <a href="client_registrationAwodr.php"> <button> Add User Data</button> </a>
                    </div>
                                ...
                                <table style="width:100%" id="datatableid" class="table table-bordered table-dark">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="width:700%"> Status </th>
               ...
               {
				 $sid = $_POST['sid'];
				 $query="SELECT * FROM form7 where sid='$sid' ";
