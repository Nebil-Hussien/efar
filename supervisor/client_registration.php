                ...
                <div class="row g-4">
                    ...
                    <div class="modal-body">
                            ...
                            var setDisp = function(e) {
                                if (select.value == 'awodr') {
                                    window.location.replace(
                                        "https://elebatsolution.et/supervisor/client_registrationAwodr.php");
                      ...
                      <input type="radio" name="gender" value="female"required> Female
                          ...
                          <div class="form-group form-focus">
									  ...
									  <br>
									    ...
									    <div class="form-group">
                                        <label for="email">Email Address <i class="fa fa-asterisk" style="font-size:12px;color:red"></i></label>
                                ...
                                <div class="modal-footer">
                                    <a href="sales_client_view.php"> <button type="button"
