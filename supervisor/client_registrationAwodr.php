        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="awoview.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Client
                        Registration</a>
  <a href="agent_view.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Agent Registration</a>

  <a href="notification.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Send Notification</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="EFAR" class="sidebar-toggler flex-shrink-0">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="clientInsertAwodr.php" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <label> First Name<i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                                        <input type="text" name="First_Name" class="form-control"
                                            placeholder="Enter Client First Name" pattern="[A-Za-z]{1,32}"
                                            title="Please enter with prorper name format " required>
                                    </div>

                                    <div class="form-group">
                                        <label>Middle Name<i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                                        <input type="text" name="Middle_Name" class="form-control"
                                            placeholder="Enter Client Middle Name" pattern="[A-Za-z]{1,32}" required>
                                    </div>


                                    <div class="form-group">
                                        <label>Last Name <i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                                        <input type="text" name="Last_Name" class="form-control"
                                            placeholder="Enter Client Last Name" pattern="[A-Za-z]{1,32}" required>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label> Phone <i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                                        <input name="phone" type="tel" id="phone" placeholder="Enter phone No"
                                    ...
                                    <br>
									<div class="form-group">
                                        <label>Age <i class="fa fa-asterisk" style="font-size:12px;color:red"></i></label>
                                        <input type="number" name="age" id="age" class="form-control"
                                            placeholder="Enter Age" pattern="[1-9]{1,2}" required>
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="familySize" id="familySize" class="form-control"
                                            placeholder="Enter Fammily Size" required>
                                    </div>
                                    <br>
                                  <div class="form-group">
                                        <label>Number of Family Subscribing</label>
                                        <input type="number" name="numberofFamily" id="numberofFamily"
                                            class="form-control" placeholder="Number of Family Subscribing" >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label> Zone <i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                                    ...
                                    <div class="form-group">
                                        <label>Booking Date <i class="fa fa-asterisk" style="font-size:12px;color:red"></i></label>
                                        <input type="date" name="bookingDate" id="bookingDate" class="form-control"
                                            >
                                    </div>
                                    <div class="form-group">
                                        <label>Booking Time <i class="fa fa-asterisk" style="font-size:12px;color:red"></i></label>
                                ...
                                <div class="modal-footer">
                                    <a href="awoview.php"> <button type="button"
                        ...
                        <div class="bg-light rounded-top p-4">
                            <div class="row">
                                <div class="col-12 col-sm-6 text-center text-sm-start">
                                    &copy; <a href="https://www.elebatsolution.com/">ELEBATSOLUTION</a>, All Right
                                    Reserved.
                                </div>
