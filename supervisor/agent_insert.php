...
$Status=$_POST['Status'];
    ...
    $query = "INSERT INTO form6 (`sid`,`Project_name`,`Client_First_Name`,`Client_Middle_Name`,`Client_Last_Name`,`gender`,`dob`,`Education`,`Work`,`phone`,`city`,`Woreda`,`Zone`,
	`Subcity`,`House`,`address`,`email`,`Status`) 
	VALUES ('$sid','$PROJECT_NAME','$Client_First_Name','$Client_Middle_Name','$Client_Last_Name','$gender','$dob','$Education','$Work','$phone','$city','$Woreda','$Zone','$Subcity','$House','$address','$email','$Status' )";
