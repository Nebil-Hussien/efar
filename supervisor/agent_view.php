    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="agent_update.php" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label> Agent First Name <i class="fa fa-asterisk" style="font-size:12px;color:red"></i>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label> Agent Middle Name<i class="fa fa-asterisk" style="font-size:12px;color:red"></i>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label> Agent Last Name <i class="fa fa-asterisk" style="font-size:12px;color:red"></i>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label> Gender
                                    <i class="fa fa-asterisk" style="font-size:12px;color:red"></i></label>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <a href="agent_register.php"> <button> Add Agent Data</button> </a>
                    </div>
                ...
                $query = "SELECT * FROM form6 ORDER BY id DESC";
            ...
            ?>
                                <table  style="width:100%" id="datatableid" class="table table-bordered table-dark">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="width:70%" > Spacific Location </th>
               ...
               {
				 $sid = $_POST['sid'];
				 $query="SELECT * FROM form6 where sid='$sid' ";
				 $query_run=mysqli_query($connection,$query);
