...
<head>
    <meta charset="utf-8">
    <title>field_officer_view</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="field_officer_register.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Sales Registration </a>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="fildupdate.php" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label> Fild OFFICER First Name </label>
                                    <input type="text" name="First_Name" id="First_Name" class="form-control"
                                        placeholder="Enter OFFICER First Name" pattern="[A-Za-z]{1,32}"
                                        title="Please enter with prorper name format " required>
                                </div>

                                <div class="form-group">
                                    <label> Fild OFFICER Middle Name </label>
                                    <input type="text" name="Middle_Name" id="Middle_Name" class="form-control"
                                        placeholder="Enter OFFICER Middle Name" pattern="[A-Za-z]{1,32}"
                                        title="Please enter with prorper name format " required>
                                </div>

                                <div class="form-group">
                                    <label> Fild OFFICER Last Name </label>
                                    <input type="text" name="Last_Name" id="Last_Name" class="form-control"
                                        placeholder="Enter OFFICER Last_Name" pattern="[A-Za-z]{1,32}"
                                        title="Please enter with prorper name format " required>
                                </div>
...
<a href="supervisor_view.php"> <button> Add User Data</button> </a>
</div>                    
