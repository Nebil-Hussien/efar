        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="agent_view.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>
                         Agent Data</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="" method="POST">
                                ...
                                <input type="text" name="Project_name" placeholder="SEARCH BY YOUR ID">
               ...
               if(isset($_POST['search']))
               {
				 ...
				 $query="SELECT * FROM form5 where Project_name='$Project_name' ";
