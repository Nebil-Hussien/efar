...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `form4` WHERE CONCAT(`id`,`Project_name`,`User_Full_Name`,`Department`,`phone`,`email`) LIKE '%".$valueToSearch."%'";
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="First_Name" id="First_Name" class="form-control"
                                placeholder="Enter User First Name"  pattern="[A-Za-z]{1,32}" title="Please enter with prorper name format " required
>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Middle_Name" id="Middle_Name" class="form-control"
                                placeholder="Enter User Middle Name" pattern="[A-Za-z]{1,32}" title="Please enter with prorper name format " required
>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Last_Name" id="Last_Name" class="form-control"
                                placeholder="Enter User Last Name" pattern="[A-Za-z]{1,32}" title="Please enter with prorper name format " required
>
                        </div>
