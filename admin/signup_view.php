...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `register` WHERE CONCAT('userid','username','email','user_type','password')LIKE '%".$valueToSearch."%'";
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="username" id="username" class="form-control"
                                placeholder="Enter username" pattern="[a-zA-Z][a-zA-Z0-9/-_\s]*" required>
...
<a href="signupform.php"> <button> Add User Account</button> </a>
</div>
