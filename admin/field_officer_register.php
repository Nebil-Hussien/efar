                ...
                <div class="row g-4">
                    ...
                    <div class="modal-body">
                     <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Field Officer First Name <i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                            <input type="text" name="First_Name" class="form-control"  pattern="[A-Za-z]{1,32}" title="Please enter with prorper name format " required>
                        </div>
						
						<div class="form-group">
                            <label>Field Officer Middle Name <i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                            <input type="text" name="Middle_Name" class="form-control"  pattern="[A-Za-z]{1,32}" title="Please enter with prorper name format " required >
                        </div> 
						
						<div class="form-group">
                            <label>Field Officer Last Name <i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                            <input type="text" name="Last_Name" class="form-control"  pattern="[A-Za-z]{1,32}" title="Please enter with prorper name format " required>
                        </div>
