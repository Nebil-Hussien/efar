...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `form3` WHERE CONCAT(`id`,`Project_name`,`First_Name`,`Middle_Name`,`Last_Name`,`gender`,`dob`,`Residential_address`,`phone`,`Qualification`,`Experience`) LIKE '%".$valueToSearch."%'";
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <form action="superupdate.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label> Supervisor First Name   <i class="fa fa-asterisk" style="font-size:12px;color:red"></i> 
                            </label>
                            <input type="text" name="First_Name" id="First_Name" class="form-control"
                                placeholder="Enter Supervisor First Name" pattern="[A-Za-z]{1,32}" title="Please enter with prorper name format " required>
                        </div> 
                        
                        <div class="form-group">
                            <label> Supervisor Middle Name   <i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                            <input type="text" name="Middle_Name" id="Middle_Name" class="form-control"
                                placeholder="Enter Middle Name" pattern="[A-Za-z]{1,32}" title="Please enter with prorper name format " required>
                        </div>
                        <div class="form-group">
                            <label> Supervisor Last Name  <i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                            <input type="text" name="Last_Name" id="Last_Name" class="form-control"
                                placeholder="Enter Supervisor Last Name" pattern="[A-Za-z]{1,32}" title="Please enter with prorper name format " required>
                        </div>
						...
						<div class="form-group">
                            <label> Phone No  <i class="fa fa-asterisk" style="font-size:12px;color:red"></i> </label>
                            <input type="text" name="Residential_address" id="Residential_address" class="form-control"
                                placeholder="Residential address" required>
                        </div>
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <form action="superdelete.php" method="POST">
...
<a href=" Supervisor_registration.php"> <button>  Add Supervisor Data</button> </a>
</div>
              ...
              <table id="datatableid" class="table table-bordered table-dark">
                        <thead>
                            <tr>
								...
								<th scope="col"> Supervisor Middle Name </th>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#phone').val(data[8]);
                $('#Qualification').val(data[9]);
                $('#Experience').val(data[10]);
            });
        });
    </script>
