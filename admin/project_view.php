...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `form1` WHERE CONCAT(`id`,`Project_name`,`Client_name`,`Description_of_project`,`status`) LIKE '%".$valueToSearch."%'";  $search_result = filterTable($query);
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Client_name" id="Client_name" class="form-control"
                                placeholder="Enter Client_name" required>
                        </div>
...
<a href="project_register.php"> <button>  Add project Data</button> </a>
</div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#Description_of_project').val(data[3]); 
				$('#status').val(data[4]);
            });
        });
    </script>
